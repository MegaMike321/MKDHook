...
struct mk_file_entry rain2_entry_table[RAIN_FILES] = {
	{"rain2.ssf"	,0, 4},
...
// I:\ps2dvd\art\rain2.ssf
struct mk_toc_entry rain2_file_table[RAIN_FILES + 1] = {
		{&rain2_entry_table[0]	,0,0 },

		{&rain2_entry_table[1]	,0,	   591744 },	// rain.sec             
		{&rain2_entry_table[2]	,0,    591744 },	// rain_ap.sec        
		{&rain2_entry_table[3]	,0,    25568  },	// rain.mko   
		{&rain2_entry_table[4]	,0,    311552 },	// sh_rain.sec           
		{&rain2_entry_table[5]	,0,    10164  },	// fight_fx.mko         
		{&rain2_entry_table[6]	,0,    21368  },	// blood_fx.mko         
		{&rain2_entry_table[7]	,0,    13696  },	// rain_fx.mko          
		{&rain2_entry_table[8] 	,0,	   12480  },	// yue_chuan.mko         
		{&rain2_entry_table[9]	,0,    10112  },	// style_yue_chuan.sec   
		{&rain2_entry_table[10]	,0,	   13440  },	// nanchuan.mko        
		{&rain2_entry_table[11]	,0,    10112  },	// style_nanchuan.sec  
		{&rain2_entry_table[12]	,0,	   11584  },	// stormsword.mko        
		{&rain2_entry_table[13]	,0,	   10112  },	// style_stormsword.sec  
		{&rain2_entry_table[14]	,0,	   148736 },	// rain_anims.sec       
		{&rain2_entry_table[15]	,0,	   132608 },	// yue_chuan_anims.sec   
		{&rain2_entry_table[16]	,0,	   150784 },	// nanchuan_anims.sec  
		{&rain2_entry_table[17]	,0,	   169344 },	// stormsword_anims.sec  
		{&rain2_entry_table[18]	,0,	   53120  },	// pz_noob_anims.sec    
...
void init_rain_toc()
{
	...
	for (int i = 0; i < RAIN_FILES; i++)
	{
		rain2_entry_table[i].belong = &rain2_file_table[0];
	}


	for (int i = 1; i < RAIN_FILES; i++)
	{
		rain2_file_table[i].previousSize = baseSize;
		baseSize += (rain2_file_table[i].size + 2048 - 1) & -2048;
	}
}
