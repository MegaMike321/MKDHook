...
struct mk_file_entry sektor2_entry_table[SEKTOR_FILES] = {
	{"sektor2.ssf"	,0, 4},
...
// I:\ps2dvd\art\sektor2.ssf
struct mk_toc_entry sektor2_file_table[SEKTOR_FILES + 1] = {
		{&sektor2_entry_table[0]	,0,0 },

		{&sektor2_entry_table[1]		,0,		531072 },	// sektor.sec             
		{&sektor2_entry_table[2]		,0,		531072 },	// sektor_ap.sec        
		{&sektor2_entry_table[3]		,0,		24576  },	// sektor.mko   
		{&sektor2_entry_table[4]		,0,		313728 },	// sh_sektor.sec           
		{&sektor2_entry_table[5]		,0,		10164  },	// fight_fx.mko         
		{&sektor2_entry_table[6]		,0,		21368  },	// blood_fx.mko         
		{&sektor2_entry_table[7]		,0,		14112  },	// sektor_fx.mko          
		{&sektor2_entry_table[8] 	,0,		13120  },	// ninjitsu.mko         
		{&sektor2_entry_table[9]		,0,		10112  },	// style_ninjitsu.sec   
		{&sektor2_entry_table[10]	,0,		8320   },	// shuaichiao.mko        
		{&sektor2_entry_table[11]	,0,		10112  },	// style_shuaichiao.sec  
		{&sektor2_entry_table[12]	,0,		12544  },	// pulseblades.mko        
		{&sektor2_entry_table[13]	,0,		10112  },	// style_pulseblades.sec  
		{&sektor2_entry_table[14]	,0,		120320 },	// sektor_anims.sec       
		{&sektor2_entry_table[15]	,0,		154132 },	// ninjitsu_anims.sec   
		{&sektor2_entry_table[16]	,0,		174720 },	// shuaichiao_anims.sec  
		{&sektor2_entry_table[17]	,0,		164400 },	// pulseblades_anims.sec  
		{&sektor2_entry_table[18]	,0,		53120  },	// pz_noob_anims.sec

		{0,0,0}
};

struct mk_file_entry sektor2_alt_entry_table[SEKTOR_FILES] = {
	{"sektor2_alt.ssf"	,0, 4},
...
// I:\ps2dvd\art\sektor2_alt.ssf
struct mk_toc_entry sektor2_alt_file_table[SEKTOR_FILES + 1] = {
		{&sektor2_alt_entry_table[0]	,0,0 },

		{&sektor2_alt_entry_table[1]	,0,		464768 },	// sektor_alt.sec             
		{&sektor2_alt_entry_table[2]	,0,		464768 },	// sektor_alt_ap.sec        
		{&sektor2_alt_entry_table[3]	,0,		24576  },	// sektor.mko   
		{&sektor2_alt_entry_table[4]	,0,		313728 },	// sh_sektor.sec           
		{&sektor2_alt_entry_table[5]	,0,		10164  },	// fight_fx.mko         
		{&sektor2_alt_entry_table[6]	,0,		21368  },	// blood_fx.mko         
		{&sektor2_alt_entry_table[7]	,0,		14112  },	// sektor_fx.mko          
		{&sektor2_alt_entry_table[8] 	,0,		13120  },	// ninjitsu.mko         
		{&sektor2_alt_entry_table[9]	,0,		10112  },	// style_ninjitsu.sec   
		{&sektor2_alt_entry_table[10]	,0,		8320   },	// shuaichiao.mko        
		{&sektor2_alt_entry_table[11]	,0,		10112  },	// style_shuaichiao.sec  
		{&sektor2_alt_entry_table[12]	,0,		12544  },	// pulseblades.mko        
		{&sektor2_alt_entry_table[13]	,0,		10112  },	// style_pulseblades.sec  
		{&sektor2_alt_entry_table[14]	,0,		120320 },	// sektor_alt_anims.sec       
		{&sektor2_alt_entry_table[15]	,0,		154132 },	// ninjitsu_anims.sec   
		{&sektor2_alt_entry_table[16]	,0,		174720 },	// shuaichiao_anims.sec  
		{&sektor2_alt_entry_table[17]	,0,		164400 },	// pulseblades_anims.sec  
		{&sektor2_alt_entry_table[18]	,0,		53120  },	// pz_noob_anims.sec
...
void init_sektor_toc()
{
	...
	for (int i = 0; i < SEKTOR_FILES; i++)
	{
		sektor2_entry_table[i].belong = &sektor2_file_table[0];
	}


	for (int i = 1; i < SEKTOR_FILES; i++)
	{
		sektor2_file_table[i].previousSize = baseSize;
		baseSize += (sektor2_file_table[i].size + 2048 - 1) & -2048;
	}

	baseSize = 2048;
	for (int i = 0; i < SEKTOR_FILES; i++)
	{
		sektor2_alt_entry_table[i].belong = &sektor2_alt_file_table[0];
	}


	for (int i = 1; i < SEKTOR_FILES; i++)
	{
		sektor2_alt_file_table[i].previousSize = baseSize;
		baseSize += (sektor2_alt_file_table[i].size + 2048 - 1) & -2048;
	}
