...
struct mk_file_entry tremor_alt_entry_table[TREMOR_FILES] = {
	{"tremor_alt.ssf"	,0, 4},

	{"tremor_alt.sec",0, 1},
	{"tremor_alt_ap.sec",0, 1},
	{"tremor.mko",0, 3},
	{"sh_tremor.sec",0, 1},
	{"fight_fx.mko",0,3},
	{"blood_fx.mko",0,3},
...
// I:\ps2dvd\art\tremor_alt.ssf
struct mk_toc_entry tremor_alt_file_table[TREMOR_FILES + 1] = {
		{&tremor_alt_entry_table[0]	,0,0 },

		{&tremor_alt_entry_table[1]			,0,		476288  },	// tremor_alt.sec             
		{&tremor_alt_entry_table[2]			,0,		476288  },	// tremor_alt_ap.sec        
		{&tremor_alt_entry_table[3]			,0,		19968   },	// tremor.mko   
		{&tremor_alt_entry_table[4]			,0,		311424  },	// sh_tremor.sec           
		{&tremor_alt_entry_table[5]			,0,		10164   },	// fight_fx.mko         
		{&tremor_alt_entry_table[6]			,0,		21368   },	// blood_fx.mko         
		{&tremor_alt_entry_table[7]			,0,		14496   },	// tremor_fx.mko          
		{&tremor_alt_entry_table[8]			,0,		11744   },	// wrestling.mko         
		{&tremor_alt_entry_table[9]			,0,		10112   },	// style_wrestling.sec   
		{&tremor_alt_entry_table[10]		,0,		13760   },	// sunbin.mko        
		{&tremor_alt_entry_table[11]		,0,		10112   },	// style_sun_bin.sec  
		{&tremor_alt_entry_table[12]		,0,		9696    },	// rockarms.mko        
		{&tremor_alt_entry_table[13]		,0,		10112   },	// style_rockarms.sec  
		{&tremor_alt_entry_table[14]		,0,		156544  },	// tremor_alt_anims.sec       
		{&tremor_alt_entry_table[15]		,0,		176052  },	// wrestling_anims.sec   
		{&tremor_alt_entry_table[16]		,0,		134016  },	// sunbin_anims.sec  
		{&tremor_alt_entry_table[17]		,0,		163840  },	// rockarms_anims.sec  
		{&tremor_alt_entry_table[18]		,0,		53120   },	// pz_noob_anims.sec
...
void init_tremor_toc()
{
	...
	for (int i = 0; i < TREMOR_FILES; i++)
	{
		tremor_alt_entry_table[i].belong = &tremor_alt_file_table[0];
	}


	for (int i = 1; i < TREMOR_FILES; i++)
	{
		tremor_alt_file_table[i].previousSize = baseSize;
		baseSize += (tremor_alt_file_table[i].size + 2048 - 1) & -2048;
	}
}